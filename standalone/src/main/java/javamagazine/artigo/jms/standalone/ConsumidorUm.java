...
public class ConsumidorUm implements ConsumidorDeMensagens {
  ...
  public ConsumidorUm() throws NamingException, JMSException {
          ...
          do {
            ...
            try {
              ...
              if (msg != null) {
                ...
                System.out.println("ConsumidorUm < " + fila.getQueueName()
                    + "[" + mensagem + "]");
